...
RSpec.describe WeaponsController, type: :controller do
  ...
  let(:valid_attributes) {
    FactoryBot.attributes_for(:weapon)
  }

  let(:invalid_attributes) {
    FactoryBot.attributes_for(:weapon, name: nil)
  }
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested weapon', :show_in_doc do
        ...
        expect(weapon.durability).to eq(new_attributes[:durability])
        expect(weapon.price).to eq(new_attributes[:price])
      end
